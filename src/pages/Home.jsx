    ...
    <main className="container">
      <section className="hero section hero-split">
        ...
        <div className="hero-left">
          ...
          <p className="sub">
            Residential construction &amp; property development in Georgia. Built
            with precision, inspected for quality, and delivered with integrity.
          </p>
        ...
        <div className="hero-right">
          ...
          {/* BIG OVERLAY TEXT (centered on image) */}
